...
def extract_prescription(llm, cleaned_text):
    prompt_extract = PromptTemplate.from_template(
        ...
        Give "not specified" to any value which is not given to you except description which you have to provide by yourself that what's that medicine is about.
        Remeber that name of any illness is not medicine's name. 
